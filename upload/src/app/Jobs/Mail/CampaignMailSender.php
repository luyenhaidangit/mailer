...
use App\Mail\SendGridCampaignMail;
...
class CampaignMailSender implements ShouldQueue
{
    ...
    {
        if (isset($this->config['provider']) && $this->config['provider'] == 'sendgrid') {
            Mail::to($this->subscriber->email)
            ->send(
                (new SendGridCampaignMail($this->campaign, $this->subscriber, $this->last))
