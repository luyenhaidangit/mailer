...
return array_merge([
    ...
    'select_all_subscribers' => 'Select All Subscribers {selected}',
    ...
    'subscriber_web_form_warning' => 'Please make sure that you have the API key available. If you do not have a valid API key please create from the API option.',
    'subscriber_web_form_message' => 'Paste the embed code into the HTML body of the page you want to display. If your site is not (https://), you must change the URL in the embed code to just (http://).<br>Use direct link to access the web form.',
    'subscriber_web_form' => 'Subscriber Web Form',
    'form' => 'Form',
    'web' => 'Web',
    'embed' => 'Embed',
    ...
    'import_subscribers_note_with_lists' => 'Import subscribers with list is time consuming. It will take a while to process. Please check the List first before using it to any campaign.',
    ...
    'export' => 'Export',
    'list_create_note_with_many_subscribers' => 'Creating list with {number} subscribers is time consuming. It will take a while so Please check the List first before using it to any campaign.',
