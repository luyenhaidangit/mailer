...
<head>
    ...
    <style>
        ...
        *, *::after, *::before {
        ...
        .feature-list {
            position: relative;
            /*background: rgb(48, 123, 255);*/
            /*background: linear-gradient(135deg, rgba(48, 123, 255, 1) 0%, rgba(48, 191, 255, 1) 100%);*/
            background: rgb(52, 165, 37);
            background: linear-gradient(135deg, rgba(52, 165, 37, 1) 0%, rgba(68, 189, 50, 1) 100%);
        }
        ...
        .third-party-lists {
            background: rgb(53, 167, 37);
            background: linear-gradient(135deg, rgba(53, 167, 37, 1) 0%, rgba(57, 171, 52, 1) 100%);
            position: relative;
            padding: 8rem 0;
            /*color: #333;*/
        }
        ...
        .customer-review-text + span.read-more-btn { display: none; }
        .customer-review-text.hide-review + span.read-more-btn { display: inline; }
    ...
    <nav class="desktop-navigation w-100 bg-white position-fixed">
        <div class="container nav-content container-sm-xl d-flex align-items-center justify-content-between flex-lg-column flex-xl-row">
            ...
            <ul class="nav-ul d-none d-lg-flex align-items-center justify-content-between list-unstyled mb-0">
                ...
                <li class="px-xl-3"><a href="https://mailer.gainhq.com/" target="_blank"
    ...
    <div class="alternate-nav hidden">
        <ul class="d-flex flex-column justify-content-center align-items-center list-unstyled h-100 w-100">
            ...
            <li class="alternate-nav-link text-uppercase"><a href="https://mailer.gainhq.com/" target="_blank"
                                                             class="alternate-nav-link text-decoration-none custom-btn bg-primary">View
                    demo</a></li>
...
<section class="hero-section text-center" id="home">
    ...
    <div class="calls-to-action mt-5">
        ...
        <a href="https://mailer.gainhq.com/documentation/" target="_blank"
    ...
    <div class="container container-sm-xl text-white px-lg-5">
        ...
        <div class="feature-list-content d-flex mt-3 flex-column flex-md-row mt-md-5 align-items-md-start">
            <div class="feature-img m-0 mt-1 order-1">
                <iframe src="https://www.youtube.com/embed/Z5TfVZwvOhs" title="YouTube video player"
                        frameborder="0"
            ...
            <div class="m-0 text-white w-100 mt-lg-0">
                <h4><strong>We are providing you with - </strong></h4>
                <ul class="features-list-ul mt-4 list-unstyled">
                    <li class="mb-2">
                        <small> <b>Dashboard</b></small>
                    </li>
                    <li class="mb-2">
                        <small> <b>Campaign</b></small>
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <small> <b>Segments</b></small>
                    </li>
                    <li class="mb-2">
                        <small> <b>Subscriber</b></small>
                    </li>
                    <li class="mb-2">
                        <small> <b>Templates</b></small>
                    </li>
                    <li class="mb-2">
                        <small> <b>Users & Roles</b></small>
                    </li>
                    <li class="mb-2">
                        <small> <b>Custom Field</b></small>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="installation-procedure shadow-sm bg-warning">
    <div class="container container-sm-xl text-white text-center">
        ...
        <a href="https://codecanyon.net/item/mailer-email-marketing-application/39029867?s_rank=2" target="_blank"
    ...
    <div class="container container-sm-xl">
        ...
        <div class="feature-display d-flex flex-wrap mt-5 border rounded p-5 bg-white">
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Campaign</h5>
                    <p class="text-muted w-100">Set different types of campaigns and send emails automatically.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    ...
                    <p class="text-muted w-100">Easily explore all emails for each campaign with a detailed view.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">List</h5>
                    <p class="text-muted w-100">Create and manage subscribers as your audience within a list .</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Segments</h5>
                    <p class="text-muted w-100">Target the right people using behavior logic.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Subscriber</h5>
                    <p class="text-muted w-100">Import subscribers from existing system and start campaign.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Templates</h5>
                    <p class="text-muted w-100">Create and customize beautiful & responsive email templates as you
                        want.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Users & Roles</h5>
                    <p class="text-muted w-100">Manage your uses with different roles and permissions.</p>
                </div>
            </div>
            ...
            <div class="feature w-100 d-flex mb-3">
                ...
                <div class="feature-desc">
                    <h5 class="text-info">Custom Field</h5>
                    <p class="text-muted w-100">Store more specific subscriber information using custom fields.</p>
                </div>
            </div>
        ...
        <div class="customization-section p-5 mx-auto mt-5 d-flex align-items-center justify-content-between flex-wrap shadow-sm rounded">
            ...
            <a href="#license-and-pricing" class="custom-btn bg-primary text-decoration-none d-inline-block"
            ...
            <div class="license-container rounded shadow-sm mb-4 w-75">
                ...
                <div class="mt-3 px-4 pb-4 d-flex flex-column">
                    ...
                    <a class="custom-btn bg-primary d-block w-75 text-center align-self-center text-decoration-none"
                       href="https://codecanyon.net/item/mailer-email-marketing-application/39029867?s_rank=2"
...
<footer class="d-flex flex-column justify-content-between">
    <div class="container container-sm-xl px-lg-5">
        <div class="footer-content d-flex justify-content-between align-items-center flex-wrap flex-lg-nowrap py-3 py-lg-0 mt-xl-4">
            ...
            <a href="https://mailer.gainhq.com/" target="_blank"
    ...
    <div class="copyright-details text-center">
        <p class="mb-0">© <span id="current-year"></span> Mailer - Self-hosted email marketing software. All Rights
            Reserved.</p>
    </div>
</footer>
