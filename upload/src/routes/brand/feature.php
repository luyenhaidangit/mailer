...
use App\Http\Controllers\{Campaign\CampaignCountController,
    ...
    Subscriber\ExportSubscriberController,
...
Route::group(['prefix' => 'subscribers', 'as' => 'subscribers.'], function (Router $router) {
    ...
    $router->get('export', [ExportSubscriberController::class, 'export'])
        ->name('export');
