...
use App\Http\Controllers\WebForm\WebFormController;
...
Route::group(['prefix' => 'brands/{brand_dashboard}/web-form'], function () {
    Route::get('subscriber', [WebFormController::class, 'subscriberCreate']);
    // Route::get('subscriber-edit/{id}', [WebFormController::class, 'subscriberEdit']); // If you want to allow editing in the web form, you can uncomment the following line
    Route::get('get-subscriber/{id}', [WebFormController::class, 'getSubscriberById']);
    Route::get('get-custom-field/{contenx?}', [WebFormController::class, 'getCustomField']);
});
